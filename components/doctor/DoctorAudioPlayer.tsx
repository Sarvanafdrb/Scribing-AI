    ...
    <div className="space-y-3 rounded-lg border border-gray-200 bg-gray-50 p-4">
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-sm transition-transform hover:opacity-90 active:scale-95"
        >
          {isPlaying ? (
        ...
        <div className="min-w-0 flex-1 space-y-1.5">
          <input
            ...
            aria-label="Seek"
            disabled={seekMax <= 0}
            className="h-1.5 w-full cursor-pointer appearance-none rounded-full bg-gray-200 accent-[var(--primary)] disabled:cursor-not-allowed disabled:opacity-60"
            style={{
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            aria-label="Volume"
            className="h-1.5 w-20 cursor-pointer appearance-none rounded-full bg-gray-200 accent-[var(--primary)]"
          />
        </div>
